...
//	  parser := gopacket_dpdk.NewDecodingLayerParser(layers.LayerTypeEthernet, &eth, &ip4, &ip6, &tcp, &udp, &payload)
//	  var source gopacket_dpdk.PacketDataSource = getMyDataSource()
//	  decodedLayers := make([]gopacket_dpdk.LayerType, 0, 10)
//	  for {
