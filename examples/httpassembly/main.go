...
// This binary provides sample code for using the gopacket_dpdk TCP assembler and TCP
...
func (h *httpStreamFactory) New(net, transport gopacket_dpdk.Flow) tcpassembly.Stream {
	hstream := &httpStream{
		net:       net,
		transport: transport,
